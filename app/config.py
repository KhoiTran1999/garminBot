...
class Config:
    ...
    MODEL_BRAIN = os.getenv("MODEL_BRAIN") or ROUTER9_COMBOS_MODEL or "gemini-3.1-pro"
    MODEL_WORKER = os.getenv("MODEL_WORKER") or ROUTER9_COMBOS_MODEL or "gemini-3.1-pro"
